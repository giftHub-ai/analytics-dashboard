...
const data = [
  ...
  { product: "Product F", month: "Feb", performance: 60 },
...
const Performance = () => {
  return (
    <>
      ...
      <div className="absolute top-5 text-black z-20 flex justify-evenly w-full">
        <h6 className="font-montserrat text-[18px] font-bold">Product sales and month</h6>
        <select name="date">
